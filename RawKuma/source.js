...
},{"./FlatMangaReaderParser":27,"paperback-extensions-common":4}],27:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
const KumaScansParser_1 = require("./KumaScansParser");
...
class KumaScans extends ReadKomik_1.ReadKomik {
    constructor() {
        super(...arguments);
        this.baseUrl = BASE;
        this.alternateTitleSeparator = /( \/ |, )/;
        this.parser = new KumaScansParser_1.KumaScansParser();
    }
}
exports.KumaScans = KumaScans;

},{"../ReadKomik/ReadKomik":31,"./KumaScansParser":29,"paperback-extensions-common":4}],29:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.KumaScansParser = void 0;
const FlatMangaReaderParser_1 = require("../FlatMangaReaderParser");
class KumaScansParser extends FlatMangaReaderParser_1.FlatMangaReaderParser {
    parseManga($, mangaId, base, source) {
        return this.parseMangaAlternate($, mangaId, base, source);
    }
}
exports.KumaScansParser = KumaScansParser;

},{"../FlatMangaReaderParser":27}],30:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class RawKuma extends KumaScans_1.KumaScans {
    constructor() {
        super(...arguments);
        this.baseUrl = BASE;
        this.language = paperback_extensions_common_1.LanguageCode.UNKNOWN;
    }
}
exports.RawKuma = RawKuma;

},{"../KumaScans/KumaScans":28,"paperback-extensions-common":4}],31:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
},{"../FlatMangaReader":26,"paperback-extensions-common":4}]},{},[30])(30)
});
