...
class AsuraScans extends FlatMangaReader_1.FlatMangaReader {
    constructor() {
        super(...arguments);
        this.baseUrl = BASE;
        this.parser = new AsuraScansParser_1.AsuraScansParser();
        this.mangaSourceDirectory = "comics";
        this.mangaPageDirectory = "manga";
    }
}
exports.AsuraScans = AsuraScans;

},{"../FlatMangaReader":28,"./AsuraScansParser":27,"paperback-extensions-common":4}],27:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./FlatMangaReaderParser":29,"paperback-extensions-common":4}],29:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
