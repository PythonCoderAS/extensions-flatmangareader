...
describe('KumaScans Tests', function () {


    var wrapper: APIWrapper = new APIWrapper();
    var source: KumaScans = new KumaScans(cheerio);
    var chai = require('chai'), expect = chai.expect;
    var chaiAsPromised = require('chai-as-promised');
    chai.use(chaiAsPromised);

    /**
     * The Manga ID for this unit test.
     * Try to choose a manga which is updated frequently, so that the historical checking test can
     * return proper results, as it is limited to searching 30 days back due to extremely long processing times otherwise.
     */
    var mangaId = "kiss-de-fusaide-bare-naide";
    ...
    it("Testing home page results for latest titles", async () => {
        let results = await wrapper.getViewMoreItems(source, "update", {}, 3)
    ...
    it("Testing home page results for project titles", async () => {
        let results = await wrapper.getViewMoreItems(source, "project", {}, 3)
