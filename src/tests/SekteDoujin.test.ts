...
import {SekteDoujin} from '../SekteDoujin/SekteDoujin'
import {APIWrapper} from "paperback-extensions-common";

describe('SekteDoujin Tests', function () {


    var wrapper: APIWrapper = new APIWrapper();
    var source: SekteDoujin = new SekteDoujin(cheerio);
